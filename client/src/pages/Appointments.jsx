...
function Appointments() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        console.log("Departments API:", departmentData);
        console.log("Doctors API:", doctorData);

        const departmentList = Array.isArray(departmentData)
          ? departmentData
          : departmentData.departments || departmentData.data || [];
  ...
  // Load slots inside reschedule modal
  useEffect(() => {
